...
urlpatterns = patterns(
    ...
    url(r'^(\d+)?/$', 'file_list', name='file_list_user'),
    ...
    url(r'^instructions/(\d+)/$', 'instructions', name='instructions'),
...
if settings.DEBUG:
    urlpatterns += patterns(
        '',
        url(r'^media/(.*)$', 'django.views.static.serve', {'document_root': settings.MEDIA_ROOT, 'show_indexes': True}, name="media"),
